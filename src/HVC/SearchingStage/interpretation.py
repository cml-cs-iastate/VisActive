...
from src.HVC.Utils.utils import load_hvc_model, get_file_name_from_path, get_ordered_file_names
from src.HVC.Utils.plot_rect import visualize_vc_rect


def vc_interpretation(training_path, search_path, image_shape, batch_size,
                      model_path, neural_network, num_classes, weight_decay, num_vc, p_h, p_w):
    """
    """
